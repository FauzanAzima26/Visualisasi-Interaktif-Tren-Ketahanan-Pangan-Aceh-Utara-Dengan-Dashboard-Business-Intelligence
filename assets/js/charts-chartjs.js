...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (horizontalBarChart) {
      const ctx = horizontalBarChart.getContext("2d"); // Penting: ambil context 2D
      const horizontalBarChartVar = new Chart(ctx, {
        type: "bar",
        data: {
      ...
      console.error("Canvas 'horizontalBarChart' tidak ditemukan!");
    }
  });
